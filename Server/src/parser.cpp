...
void Parser::networkDownloadLog(t_cmd *command)
{
...
void Parser::networkDownloadLogEnd(t_cmd *command)
{
...
void Parser::networkDisplayLog(t_cmd *command)
{
...
void Parser::networkDisplayLogEnd(t_cmd *command)
{
...
void Parser::parseNetwork(char *buffer)
{
  ...
  networkDownloadLog(command);
  networkDownloadLogEnd(command);
  networkDisplayLog(command);
  networkDisplayLogEnd(command);
}

void Parser::commandList(std::string &cmd)
{
...
void Parser::commandExit(std::string &cmd)
{
...
void Parser::comandClose(std::string &cmd)
{
...
void Parser::commandPurge(std::string &cmd)
{
...
void Parser::commandDownload(std::string &cmd)
{
...
void Parser::commandDisplay(std::string &cmd)
{
...
void Parser::checkCommandBuffer(int size)
{
